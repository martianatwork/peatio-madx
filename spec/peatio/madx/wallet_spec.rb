RSpec.describe Peatio::Madx::Wallet do
  let(:wallet) { Peatio::Madx::Wallet.new }
  ...
  context :configure do
    let(:unconfigured_wallet) { Peatio::Madx::Wallet.new }
    ...
    it 'sets settings attribute' do
      ...
      expect(unconfigured_wallet.settings).to eq(settings.slice(*Peatio::Madx::Wallet::SUPPORTED_SETTINGS))
    end
  end
